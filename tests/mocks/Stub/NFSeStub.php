...
class NFSeStub
{
    ...
    public static function autorizada(): string
    {
        return json_encode([
            ...
            'url_danfse' => 'https://focusnfe.s3.sa-east-1.amazonaws.com/arquivos/07504505000132_12345/202401/DANFSEs/075045050001324106902-004949940-433-DUMMY-nfse.pdf',
        ]);
    }
    ...
    /**
     * Retorna dados mocados de NFSe não encontrada
     */
    public static function naoEncontrada(): string
    {
        return json_encode([
