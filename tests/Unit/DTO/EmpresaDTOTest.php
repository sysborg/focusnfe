...
class EmpresaDTOTest extends TestCase
{
    ...
    public function test_normaliza_orientacao_danfe_legado_ladscape(): void
    {
        $dados = $this->getDadosValidos();
        $dados['orientacaoDanfe'] = 'ladscape';

        $empresa = EmpresaDTO::fromArray($dados);

        $this->assertSame('landscape', $empresa->orientacaoDanfe);
        $this->assertSame('landscape', $empresa->toArray()['orientacao_danfe']);
    }
